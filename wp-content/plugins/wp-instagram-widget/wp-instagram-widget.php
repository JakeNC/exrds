	...
	function widget( $args, $instance ) {
		...
		if ( '' !== $username ) {
			...
			if ( is_wp_error( $media_array ) ) {
				...
				$ulclass = apply_filters( 'wpiw_list_class', 'ig-pics instagram-size-' . $size );
				$liclass = apply_filters( 'wpiw_item_class', 'ig-item' );
				$aclass = apply_filters( 'wpiw_a_class', 'ig-a' );
				$imgclass = apply_filters( 'wpiw_img_class', 'ig-img' );
